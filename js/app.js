let data = {
    ...
    socials: [{
            id: 'fb',
            service: 'Facebook',
            url: 'https://www.facebook.com/steve',
            icon: 'fab fa-facebook'
        },
        {
            id: 'ig',
            service: 'Instagrqam',
            url: 'https://www.instagram.com/steve',
            icon: 'fab fa-instagram'
        },
        {
            id: 'db',
            service: 'Dribbble',
            url: 'https://www.dribbble.com/steve',
            icon: 'fab fa-dribbble'
        },
        {
            id: 'gl',
            service: 'Google',
            url: 'https://www.google.com/steve',
            icon: 'fab fa-dribbble'
        }
    ]
}
let fullName = 'Steve Kai'
let position = 'UI/UX Designer'
